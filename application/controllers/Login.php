            ...
            if ($this->form_validation->run()== true) {
                ...
                if (!empty($da)) {
                    ...
                    if ($nnn2==$pass) {
                        ...
                        $nnn5=$da->services;
                        $nnn6=$da->id;
                        $designation=$da->designation_id;
                        $state=$da->state_id;
                        $territory=$da->territory_id;
                        ...
                        $this->session->set_userdata('designation_id', $designation);
                        $this->session->set_userdata('state_id', $state);
                        $this->session->set_userdata('territory_id', $territory);
