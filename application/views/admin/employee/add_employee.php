                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <tr>
                                                          ...
                                                          <td>
          													<input type="text" name="territory"  class="form-control" placeholder="" required value="" />
          	                                            </td>
              										</tr>
                                  <tr>
                                    ...
                                    <tr>
                                                              ...
                                                              <td>
              													<input type="text" name="tour_details"  class="form-control" placeholder="" required value="" />
              	                                            </td>
                  										</tr>
                                      <tr>
                                                                <td> <strong>Kilometer Details</strong>  <span style="color:red;">*</span></strong> </td>
                                                                <td>
                													<input type="text" name="km_details"  class="form-control" placeholder="" required value="" />
                	                                            </td>
                    										</tr>
                                        <tr>
                                                                  <td> <strong>Sales Details</strong>  <span style="color:red;">*</span></strong> </td>
                                                                  <td>
                  													<input type="text" name="sales_details"  class="form-control" placeholder="" required value="" />
                  	                                            </td>
                      										</tr>
