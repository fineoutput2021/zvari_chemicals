<div class="content-wrapper">
  <section class="content-header">
   ...
   <li><a href="<?php echo base_url() ?>dcadmin/Employee/view_employee"><i class="fa fa-dashboard"></i> View Employee</a></li>
  </ol>
  </section>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="state_id" required id="state">
                          ...
                          <option value="<?=$data->id?>" <?if ($data->id==$employee_data->state_id) {
                                                 echo "selected";
                                             }?>><?=$data->name?></option>
                          <?php $i++; } ?>
                        </select> </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="territory_id" required id="territory">
                          ...
                          <option value="<?=$data->id?>" <?if ($data->id==$employee_data->territory_id) {
                                                 echo "selected";
                                             }?>><?=$data->name?></option>
                          <?php $i++; } ?>
                        </select> </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="position_id" required id="position">
                          <option value="">------Select Designation---------</option>
                          <?php $i=1; foreach ($position_data->result() as $data) { ?>
                          <option value="<?=$data->id?>" <?if ($data->id==$employee_data->position_id) {
                                                 echo "selected";
                                             }?>><?=$data->name?></option>
                          <?php $i++; } ?>
                        </select> </td>
