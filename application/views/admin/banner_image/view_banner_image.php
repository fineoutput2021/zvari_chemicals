        ...
        <div class="row">
        <div class="col-lg-12">
        <!-- <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/Banner_image/add_banner_image"
 	 ...
 	 <th>Image2</th>
        ...
        <tbody>
        <?php $i=1; foreach ($banner_image_data->result() as $data) { ?>
        <tr>
        <td><?php echo $i ?> </td>
        ...
        <a href="<?php echo base_url() ?>dcadmin/Banner_image/delete_banner_image/<?php echo
